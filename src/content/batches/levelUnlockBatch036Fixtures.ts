...
function singleFixtures(problem: (typeof levelUnlockBatch036Problems)[number]): readonly ProblemFixture[] {
...
function mixedFixtures(problem: (typeof levelUnlockBatch036Problems)[number]): readonly ProblemFixture[] {
...
export const levelUnlockBatch036Fixtures: readonly ProblemFixture[] =
  levelUnlockBatch036Problems.flatMap((problem) =>
