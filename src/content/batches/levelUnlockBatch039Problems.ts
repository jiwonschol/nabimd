...
export const levelUnlockBatch039Id = "2026-08-31-l2-l3-unlock-039"
...
function createSingleProblem(input: SingleInput, variant: number): NormalizedProblem {
  ...
  return {
    ...
    sourceBatchId: levelUnlockBatch039Id,
    revision: 1,
    curriculumVersion,
...
export const levelUnlockBatch039Problems: readonly NormalizedProblem[] = [
  ...singleProblems,
  ...mixedProblems,
]
