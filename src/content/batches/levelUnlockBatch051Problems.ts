...
export const levelUnlockBatch051Id = "2026-08-31-l2-l3-unlock-051"
...
function createSingleProblem(input: SingleInput, variant: number): NormalizedProblem {
  ...
  return {
    ...
    sourceBatchId: levelUnlockBatch051Id,
    revision: 1,
    curriculumVersion,
...
export const levelUnlockBatch051Problems: readonly NormalizedProblem[] = [
  ...singleProblems,
  ...mixedProblems,
]
