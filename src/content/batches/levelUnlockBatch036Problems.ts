...
export const levelUnlockBatch036Id = "2026-08-31-l2-l3-unlock-036"
...
function createSingleProblem(input: SingleInput, variant: number): NormalizedProblem {
  ...
  return {
    ...
    sourceBatchId: levelUnlockBatch036Id,
    revision: 1,
    curriculumVersion,
...
export const levelUnlockBatch036Problems: readonly NormalizedProblem[] = [
  ...singleProblems,
  ...mixedProblems,
]
