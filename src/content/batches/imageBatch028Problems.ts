...
export const imageBatch028Id = "2026-08-28-l1-images-028"
...
export type ImageBatch028Input = {
  id: string
...
export const imageBatch028Inputs: readonly ImageBatch028Input[] = [
  {
...
function createImageProblem(input: ImageBatch028Input): NormalizedProblem {
  return {
    id: input.id,
    schemaVersion: 2,
    level: 1,
...
export const imageBatch028Problems: readonly NormalizedProblem[] =
  imageBatch028Inputs.map(createImageProblem)
