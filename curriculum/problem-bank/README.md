...
schema-v2 tracker currently publishes 116 inspected `standard` problems: 52 at
...
carries 360; the first ordered-list expansion carries 624. Each immutable batch
has two sealed independent reviews and one separate editorial decision.
...
currently reports 116. New families publish in small batches only after their
